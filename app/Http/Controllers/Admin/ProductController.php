...
class ProductController extends Controller
{
    ...
    private $paginate = 10;
    private $search = ['name','description','value','stock'];
    private $model;
    ...
    public function index(Request $request)
    {
        ...
        $columnList = ['id'=>'#','name'=>trans('linguagem.name'),'description'=>trans('linguagem.description'),'value'=>trans('linguagem.value'), 'stock'=>trans('linguagem.stock')];
        ...
        $page = trans('linguagem.product_list'); // traduzindo o titulo da lista
    ...
    public function create()
    {
        ...
        $page = trans('linguagem.product_list'); // traduzindo o titulo da lista
        $page_create = trans('linguagem.product');
        $routeName = $this->route; // passando a rota - caminho
